...
Route::group(['middleware' => 'auth:user'],function (){
    Route::prefix('admin')->group(function (){
        ...
        Route::get('/kategori/export-pdf',[\App\Http\Controllers\KategoriKontroller::class, 'exportPdf'])->name('kategori.exportPdf');
        ...
        Route::get('/user',[\App\Http\Controllers\UserKontroller::class, 'index'])->name('user.index');
        Route::get('/user/tambah',[\App\Http\Controllers\UserKontroller::class, 'tambah'])->name('user.tambah');
        Route::post('/user/prosesTambah',[\App\Http\Controllers\UserKontroller::class, 'prosesTambah'])->name('user.prosesTambah');
        Route::get('/user/ubah/{id}',[\App\Http\Controllers\UserKontroller::class, 'ubah'])->name('user.ubah');
        Route::post('/user/prosesUbah',[\App\Http\Controllers\UserKontroller::class, 'prosesUbah'])->name('user.prosesUbah');
        Route::get('/user/hapus/{id}',[\App\Http\Controllers\UserKontroller::class, 'hapus'])->name('user.hapus');

        Route::get('/page',[\App\Http\Controllers\PageKontroller::class, 'index'])->name('page.index');
        Route::get('/page/tambah',[\App\Http\Controllers\PageKontroller::class, 'tambah'])->name('page.tambah');
        Route::post('/page/prosesTambah',[\App\Http\Controllers\PageKontroller::class, 'prosesTambah'])->name('page.prosesTambah');
        Route::get('/page/ubah/{id}',[\App\Http\Controllers\PageKontroller::class, 'ubah'])->name('page.ubah');
        Route::post('/page/prosesUbah',[\App\Http\Controllers\PageKontroller::class, 'prosesUbah'])->name('page.prosesUbah');
        Route::get('/page/hapus/{id}',[\App\Http\Controllers\PageKontroller::class, 'hapus'])->name('page.hapus');
